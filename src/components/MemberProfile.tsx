    ...
    <div className="px-4 pt-safe">
      <header className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-1 flex items-center gap-1.5 text-sm font-semibold tracking-[0.3em] text-muted-foreground">
            <span>{memberStatusLabel(member.statusId, member.activeCount, member.gender)}</span>
            <RankInfoButton
